...
RSpec.describe "Transactions", type: :request do
  ...
  describe 'create' do
    it 'creates transaction' do
      ...
      expect(transaction.is_split).to be transaction_data[:attributes][:is_split]
    end

    it 'creates transaction with minimal data' do
      transaction_data[:attributes].except!(:location, :note, :is_split)
  ...
  describe 'update' do
    it 'updates transaction' do
      ...
      expect(record.is_split).to eq transaction_data[:attributes][:is_split]
    end
  end
end
